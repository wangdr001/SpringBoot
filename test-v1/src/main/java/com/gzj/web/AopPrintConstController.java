...
public class AopPrintConstController {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(AopPrintConstController.class);

    /**
     * 横切点，哪些方法需要被横切.
     */
    @Pointcut(value = "execution(public * com.gzj.controller.SchClassController.*(..))")
